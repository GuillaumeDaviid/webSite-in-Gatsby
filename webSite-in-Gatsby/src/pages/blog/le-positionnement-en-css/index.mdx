...
featuredImage: "./z-index-red.jpg"
hero_image: "./z-index-red.jpg"
hero_image_alt: "CSS positionnement"
...
Il y a quelques cas particuliers, je vous invite à aller checker la [documentation](https://developer.mozilla.org/fr/docs/Web/CSS/position#types_de_positionnement) pour en savoir plus.
...
Les unités de viewports qu’on a vu [ici](https://guillaumedaavid.medium.com/css-les-unit%C3%A9s-de-mesure-1bd334cd35a0) peuvent aussi être appliqué à ces propriétés.
...
Bref, il y aurait d’autres choses à dire, mais je vous laisse aller lire la [doc](https://developer.mozilla.org/fr/docs/Web/CSS/position#types_de_positionnement) si cela vous intéresse.
