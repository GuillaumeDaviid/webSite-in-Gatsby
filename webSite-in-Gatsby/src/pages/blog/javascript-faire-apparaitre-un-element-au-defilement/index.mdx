...
featuredImage: "./scrollreveal.jpg"
hero_image: "./scrollreveal.jpg"
hero_image_alt: "Scroll reveal"
hero_image_credit_text: "Scroll"
---
...
1. **HTML** → C’est la base des bases, connaître les balises les plus couramment utilisées suffira ici.

2. **Javascript** → Il vous faudra connaître, là aussi, les bases de Javascript. Pas besoin d’être un crack, si vous savez, par exemple, utiliser des fonctions ou encore l’utilisation des classes, cela sera largement suffisant.

3. **Un éditeur de texte** → Si vous remplissez les deux premiers prérequis, alors normalement, vous remplissez aussi celui-ci, mais au cas ou, utilisez celui avec lequel vous êtes le plus à l’aise. Si vous ne savez pas lequel utiliser, je peux vous conseiller Atom ou encore Vs Code.

## ScrollReveal :
Pour faire apparaître un élément au défilement, nous allons utiliser une librairie javascript qui porte le nom de [ScrollReveal](https://scrollrevealjs.org/).
...
## L’installation :
Pour commencer, nous devons installer [ScrollReveal](https://scrollrevealjs.org/).

Il existe deux manières de faire :

1. l’installer via la commande npm de Node.JS

2. Utiliser un CDN(content delivery network) qui conservera pour nous les fichiers à utiliser sur un serveur. C’est cette solution que nous allons utiliser, déjà parce qu’elle ne demande aucune installation particulière sur notre machine, mais surtout, car c’est la solution recommandée par les développeurs de [ScrollReveal](https://scrollrevealjs.org/).
...
`gist:GuillaumeDaviid/a4648d9aa560042234e7efea459844b2`
...
`gist:GuillaumeDaviid/a8e2e4a717f9df7e951251c7fbf2c78e`
...
`gist:GuillaumeDaviid/a19428a97887322a2d0e45300a98f61d`
...
`gist:GuillaumeDaviid/4121259c672762f524ccd191c21e52e2`
